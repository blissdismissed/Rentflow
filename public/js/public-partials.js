...
(function () {
  ...
  function buildNav(active) {
    ...
    return '<nav class="bg-white shadow-sm sticky top-0 z-50">'
      ...
      + '</div>'
      + '<button id="mobile-menu-button" class="md:hidden ml-auto p-2 rounded-lg text-gray-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-teal-500">' + HAMBURGER + '</button>'
      + '</div></div></nav>'
