...
(function () {
  ...
  var FOOTER_HTML = '<footer class="bg-gray-900 text-gray-300 mt-16">'
    ...
    + '<div class="flex items-center space-x-3 mb-4"><h3 class="text-xl font-display font-bold text-white">RentFlow</h3></div>'
    ...
    + '<p class="text-sm text-gray-500">© 2026 RentFlow. All rights reserved.</p>'
