...
router.post('/bulk-import', guestController.bulkImport)
router.post('/send-email', guestController.sendMarketingEmail)
router.post('/manual-stay', guestController.manualStay)
